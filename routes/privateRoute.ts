...
// Import Roles && Rights
import { DASHBOARD, STUDENTS, SETTINGS, INTERNS, FILES } from '../common/constants/role-rights/rights';
...
export const PRIVATE_ROUTE_CONFIG: Record<string, IPRIVATE_CONFIG> = {
    ...
    FILES: { isPrivate: true, title: 'Interns', hasProfile: onlyStudent, hasRight: FILES, redirectUrl: '/files' },
